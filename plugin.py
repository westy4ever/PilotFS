...
try:
    ...
    print("[PilotFS FATAL] Cannot import Enigma2 modules: %s" % str(e))
    print("[PilotFS FATAL] This plugin only runs within Enigma2 environment")
    sys.exit(1)

# ===== FIX 1: Python 2 compatibility =====
PY2 = sys.version_info[0] == 2
if not PY2:
    print("[PilotFS] WARNING: Enigma2 typically uses Python 2.7")
...
try:
    ...
    print("[PilotFS] Translation import error: %s" % str(e))
...
try:
    ...
    try:
        ...
        logging.basicConfig(
            ...
            filename='/tmp/pilotfs_fallback.log'
        )
...
def main(session, **kwargs):
    ...
    try:
        ...
        try:
            ...
            logger.info("✓ Successfully imported PilotFSMain")
            ...
            try:
                ...
                logger.info("✓ Successfully imported PilotFSMain (relative)")
            except ImportError:
        ...
        error_msg = "Failed to start PilotFS: %s" % str(e)
        ...
        try:
            session.open(
                MessageBox,
                _("Failed to start PilotFS") + ":\n\n%s\n\n%s" % (
                    str(e)[:100], 
                    _("Check /tmp/pilotfs.log for details")
                ),
...
def Plugins(**kwargs):
    ...
    possible_icon_locations = [
        "/usr/lib/enigma2/python/Plugins/Extensions/PilotFS/pilotfs.png",
        "/usr/share/enigma2/picon/pilotfs.png",
    ]
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("PilotFS Platinum v6.1 - Test Mode")
    print("=" * 50)
    print("Python version: %s" % sys.version)
    print("This plugin is designed to run within Enigma2.")
    print("Install path should be: /usr/lib/enigma2/python/Plugins/Extensions/PilotFS/")
    print("=" * 50)
